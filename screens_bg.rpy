...
translate russian strings:
    ...
    old "\nWhile Fiona is Marion's beloved heifer and Gladys is Jessie's prize sow, the animal pair doesn't always see hoof to snout. Glady prefers warm temperatures, and occasionally uses her nose to unlatch the pig pen gate and wriggle her way into the barn on snowy nights. Fiona tolerated the visitor as a piglet, but has made a point of mooing mournfully when girthy Gladys now shoves her way through the herd and nips at ankles to get the cows to let her sleep among them. Many a winter evening, Jessie has had to haul Gladys back out to her pen, covering her with house quilts, and leaving Marion to wonder why the linens so often smell of swine.\n\n{image=ctc_anchored}"
    new ""

    # game/screens_bg.rpy:1368
